	...
	public Properties init_properties() {
		...
		try {
			...
			if (env.equals("qa")) {
				...
				path="workspace/HRMOrangeC4/src/main/java/com/qa/orangehrm/config/config.stg.properties";
			}
		...
		//String path = "./src/main/java/com/qa/orangehrm/config/config.properties";
		try {
