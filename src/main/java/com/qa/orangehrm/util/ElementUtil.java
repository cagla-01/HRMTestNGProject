...
public class ElementUtil extends BasePage{// because I created higlight element in base class
	...
	public WebElement getElement(By locator) {
		...
		if (highlightElement) {// sayfa basindaki extends i bunun icin kullaniyoruz cunku base te highligt var
